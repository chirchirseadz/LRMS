        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-12">
                            <form role="form" id="form" action="{{ route('flat.update', $flat->id) }}" method="post">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control" id="name" placeholder="Enter flat name" autocomplete="off" value="{{$flat->name}}" required>
                                            </div>
                                        </div>
                                        @error('name')
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="location" class="form-control" id="name" placeholder="Enter location name" autocomplete="off" value="{{$flat->location}}" required>
                                            </div>
                                        </div>
                                        @error('location')
                                            <span class="text text-danger text-sm" role="alert">
